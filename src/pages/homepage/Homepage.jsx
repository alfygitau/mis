        ...
        <div className="flex h-[600px] sm:h-full my-[20px] w-full flex justify-between sm:flex-col sm:gap-[20px]">
          <div className="w-[48%] sm:w-[100%] bg-white h-full p-[20px]">
            ...
            <div className="flex items-center my-[20px] px-[30px] gap-[30px]">
              <input
                className="h-[40px] w-[49%] text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
                type="date"
                name="pricedate"
                id="pricedate"
                value={priceDate}
              ...
              <select
                ...
                className="h-[40px] w-[49%] text-gray-600 text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
              >
          ...
          <div className="w-[48%] sm:w-[100%] bg-white h-full p-[20px]">
            ...
            <div className="flex items-center my-[20px] px-[30px] gap-[30px]">
              <input
                className="h-[40px] w-[24%] text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
                type="date"
                name="pricedate"
                id="pricedate"
              ...
              <select
                ...
                onChange={(e) => handleCountyChange(e.target.value)}
                placeholder="Enter your county"
                className="h-[40px] w-[24%] text-gray-600 text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
              >
                {priceCounties?.length > 0 &&
                  priceCounties?.map((county) => (
                    <option key={county.countyId} value={county.countyId}>
        ...
        <div className="flex h-[600px] sm:h-full my-[20px] w-full flex justify-between sm:flex-col sm:gap-[20px]">
          <div className="w-[48%] sm:w-[100%] bg-white h-full p-[20px]">
            ...
            <div className="flex items-center my-[20px] justify-between px-[30px] gap-[10px]">
              <input
                className="h-[40px] w-[30%] text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
                type="date"
                name="pricedate"
                id="pricedate"
          ...
          <div className="w-[48%] sm:w-[100%] bg-white h-full p-[20px]">
            ...
            <div className="flex items-center my-[20px] justify-between px-[30px] gap-[10px]">
              ...
              <select
                ...
                placeholder="Enter your county"
                className="h-[40px] w-[49%] rounded text-gray-600 text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
              >
                {priceCounties?.length > 0 &&
                  priceCounties?.map((county) => (
                    <option key={county.countyId} value={county.countyId}>
        ...
        <div className="flex h-[600px] sm:h-full  my-[20px] w-full flex justify-between sm:flex-col sm:gap-[20px]">
          <div className="w-[48%] sm:w-[100%] bg-white h-full p-[20px]">
            ...
            <div className="flex items-center my-[20px] px-[30px] gap-[10px]">
              <input
                className="h-[40px] w-[19%] text-[14px]  border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
                type="date"
                name="pricedate"
                id="pricedate"
              ...
              <select
                ...
                placeholder="Enter your county"
                className="h-[40px] w-[19%] rounded text-gray-600 text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
              >
                {priceCounties?.length > 0 &&
                  priceCounties?.map((county) => (
                    <option key={county.countyId} value={county.countyId}>
