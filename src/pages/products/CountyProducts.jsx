  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center my-[10px] text-[13px] justify-between">
        <p className="text-[13px] uppercase font-bold">County value chains</p>
      </div>
      <div className="w-full h-[60px] rounded shadow-md my-[10px] bg-white px-[10px] flex justify-between items-center">
        <div className="flex w-full items-center gap-[20px]">
          <select
            ...
            className="h-[40px] w-[15%] text-[#000] text-[12px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
          >
          ...
          <input
            ...
            className="h-[40px] w-[15%] text-[#000] text-[14px] border px-[10px] border-gray-300 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-primary-110"
          />
          <input
            type="date"
            value={endDate}
        ...
        <div className="flex items-center gap-[20px]">
          ...
          <button
            onClick={showModal}
            className="h-[40px] w-[40px] rounded bg-[#00599A] flex items-center font-bold justify-center gap-[10px] text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
